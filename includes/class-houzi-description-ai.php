...
class Houzi_Description_Ai
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Houzi_Description_Ai_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'houzi-description-ai';
	 ...
	 *
	 * - Houzi_Description_Ai_Loader. Orchestrates the hooks of the plugin.
	 * - Houzi_Description_Ai_i18n. Defines internationalization functionality.
	 * - Houzi_Description_Ai_Admin. Defines all hooks for the admin area.
	 * - Houzi_Description_Ai_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Houzi_Description_Ai_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
